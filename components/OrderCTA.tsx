...
export default function OrderCTA() {
  return (
    <section className="relative overflow-hidden bg-czysty-green py-24 lg:py-32">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 lg:px-14 text-center reveal">
        <p className="font-body text-czysty-cream/60 text-[11px] uppercase tracking-[0.3em] mb-4">
          Ready to get started?
        </p>
        <h2
          className="display-heading text-czysty-cream mb-6"
        ...
        <p className="font-body text-czysty-cream/65 text-base mb-12 max-w-md mx-auto leading-relaxed">
          Book your first pickup in under 60 seconds. No contract, no commitment.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-4">
          <a href="#contact"
            className="czysty-btn bg-czysty-black text-czysty-cream hover:bg-czysty-grey transition-colors duration-200 px-9 py-4 text-sm border border-czysty-cream/10">
            Schedule Pickup Online
          </a>
          <a href="tel:+2340000000000"
            className="czysty-btn border-2 border-czysty-cream/70 text-czysty-cream hover:bg-czysty-cream hover:text-czysty-green transition-all duration-200 px-9 py-4 text-sm">
            Call Us
          </a>
          <a href="https://wa.me/2340000000000" target="_blank" rel="noopener noreferrer"
            className="czysty-btn bg-czysty-red text-czysty-cream hover:bg-czysty-red/80 transition-colors duration-200 px-9 py-4 text-sm">
            WhatsApp →
          </a>
        </div>
