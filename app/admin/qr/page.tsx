  ...
  return (
    <main className="min-h-screen bg-[#F7F4EF] flex flex-col items-center justify-center px-6 py-16">
      ...
      <p className="font-body text-czysty-muted text-[13px] mb-10 text-center max-w-sm">
        Print or display this QR code. Customers scan it, register, and land on
        your services page.
      </p>

      {notConfigured ? (
        <div className="bg-white border border-czysty-red/30 p-8 max-w-sm text-center">
          <p className="font-display font-bold text-czysty-red uppercase text-sm mb-2">
            QR_SECRET not set
          </p>
          <p className="font-body text-czysty-muted text-[13px] leading-relaxed">
            Add{" "}
            <code className="bg-czysty-cream px-1 py-0.5 text-czysty-black text-[12px]">
              QR_SECRET=your_secret_here
            </code>{" "}
            to your{" "}
            <code className="bg-czysty-cream px-1 py-0.5 text-czysty-black text-[12px]">
              .env.local
        ...
        <>
          ...
          <div className="mt-12 max-w-sm w-full border-t border-czysty-green/10 pt-8 space-y-3">
            <p className="font-display font-bold text-czysty-black uppercase text-[11px] tracking-widest mb-4">
              How it works
            </p>
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <span className="font-display font-extrabold text-czysty-green text-[11px] w-4 flex-shrink-0 mt-0.5">
                  0{i + 1}
                </span>
                <p className="font-body text-czysty-muted text-[13px] leading-relaxed">
                  {step}
